...
public:
	...
	void hurtCarrot();
	BarrierBase* getBTarget() { return nowBTarget; };
	MonsterBase* getMTarget() { return nowMTarget; };
	void setBTarget(BarrierBase* b) { nowBTarget = b; };
	void setMTarget(MonsterBase* m) { nowMTarget = m; };
